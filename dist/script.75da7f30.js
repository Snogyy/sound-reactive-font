...
require("./styles.css");
var el = document.querySelector("#app h1");
var sourceStr = "Clap your hands!";
var strArray = sourceStr.split("");
var bins = 16;
function initElements() {
  for (var i = 0; i < strArray.length; i++) {
    var letter = strArray[i];
    var phraseAtom = document.createElement("SPAN");
  ...
  navigator.mediaDevices.getUserMedia({
    ...
    function setFontFeatures(avg) {
      ...
      for (var i = els.length - 1; i >= 0; i--) {
        var _el = els[i];
        _el.style.fontVariationSettings = "\"wght\" ".concat(map(avgHistory[i], 0, 64, 10, 100));
      }
    }
    function draw(now) {
